...
const TOUR_TARGETS = [
  ...
  { id: "custom-build", target: '[data-tour="custom-build"]', label: "Кастомная сборка", icon: "", defaultPlacement: "right", description: "Кастомная конфигурация", previewImage: "/tour-targets/custom-build.png", defaultRoute: null },
