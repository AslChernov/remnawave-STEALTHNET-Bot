...
export const RU: Record<string, string> = {
  ...
  "referral.site": "Сайт:",
  "referral.bot": "Бот:",
  "referral.copy_site": "📋 Скопировать ссылку сайта",
  "referral.copy_bot": "📋 Скопировать ссылку бота",
  ...
  "devices.no_devices": "📱 Устройства\n\nПривязанных устройств пока нет. Подключитесь с приложения — устройство появится здесь. Удалять можно старые устройства, чтобы освободить слот для нового.",
  ...
  "vpn.link_unavailable": "Ссылка недоступна. Оформите подписку.",
  "vpn.connect_title": "Подключиться",
  ...
  "support.btn_agreement": "📜 Пользовательское соглашение",
...
const EN: Record<string, string> = {
  ...
  "referral.bot": "Bot:",
  "referral.copy_site": "📋 Copy website link",
  "referral.copy_bot": "📋 Copy bot link",
  ...
  "devices.no_devices": "📱 Devices\n\nNo linked devices yet. Connect from an app — the device will appear here. You can remove old devices to free a slot for a new one.",
  ...
  "vpn.link_unavailable": "Connection link is unavailable. Get a subscription.",
  "vpn.connect_title": "Connect",
