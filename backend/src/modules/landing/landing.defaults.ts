  ...
  switch (key) {
      ...
      return {
        i18n: {
          ru: {
            ...
            items: [
              { q: "Что даёт сервис доступа?", a: "Сервис помогает обойти блокировки и обеспечивает стабильный доступ к нужным сайтам и приложениям — дома, в поездках и за рубежом." },
    ...
    case "custom/footer":
      return {
        i18n: {
          ru: {
            footerText: `© ${new Date().getFullYear()} ALTETH. Все права защищены.`,
          },
        },
      };
        ...
        i18n: {
          ru: {
            ...
            items: [
              ...
              { text: "Цены прозрачные, поддержка отвечает быстро. Лучшее, что пробовала для стабильного доступа.", author: "Мария", role: "клиент" },
