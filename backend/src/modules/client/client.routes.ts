...
publicConfigRouter.get("/manifest.webmanifest", async (_req, res) => {
  try {
    ...
    const manifest = {
      ...
      description: `${brand} — личный кабинет и админка`,
      lang: "ru",
      start_url: "/cabinet",
      scope: "/",
      display: "standalone",
